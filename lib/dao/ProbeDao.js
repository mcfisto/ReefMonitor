...
var _internal = {
	rowMapper: function(probe, row){
		...
		probe.code = row.code;		
		probe.type = row.type;
		probe.connectionType = row.connection_type;
		probe.unit = row.unit;
	...
	SQL_BASE: "SELECT name, code, type, connection_type, unit, system_id, min, max, min_w, max_w, is_in_service, is_system, last_calibration_date, last_replacement_date "
		+ " FROM probes ",
		
	SQL_BASE_WITH_LAST_VALUE: "SELECT name, code, type, connection_type, unit, system_id, min, max, min_w, max_w, is_in_service, is_system, last_calibration_date, last_replacement_date "
		+", ("
